...
$(document).ready(function(){
	$("a[name='login']").click(function(){
		$.ajax({
			type:"POST",
			url:"${pageContext.request.contextPath}/loginManVerify.do",
    ...
    <div class="row-fluid login-wrapper">
        ...
        <div class="span4 box">
            <div class="content-wrap">
                <h6>Log in</h6>
                <form id = "myform" method="POST" action="${pageContext.request.contextPath}/loginMan.do">
                ...
                <a class="btn-glow primary login" name="login">Log in</a>
            </div>
        </div>
